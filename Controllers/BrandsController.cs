...
namespace TrainingUAJY.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdBrand,Title")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IdBrand,Title")] Brand brand)
        {
            if (ModelState.IsValid)
            {
